...
<body>
	<div style="width: 100%; height: 400px;">
		<div id="canvas">
			<div id="south"></div>
			<div id="seoul">
				<a href="${pageContext.request.contextPath}/content/springview?travel_season=4&travel_devide=서울"><h2>서울특별시</h2></a>
			</div>
			<div id="gygg">
				<a href="${pageContext.request.contextPath}/content/springview?travel_season=4&travel_devide=gygg"><h2>경기도</h2></a>
			</div>
			<div id="incheon">
				<h2>인천광역시</h2>
			</div>
