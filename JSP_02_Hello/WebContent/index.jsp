...
/*
	...
	static 방식 : 문서파일 형태로 화면을 구현하고, 누구에게나 거의 유사한
			화면을 보여주는 방식
	danamic 방식 : DB, App과 연동되어서 사용자의 요구사항에 따라
...
<body>
<h3>나의 홈페이지</h3>
<p>나(<%= strName %>)의 홈페이제에 오신것을 환영합니다</p>
...
<p><a href="page.jsp?strName=<%=strName%>">나의 정보</a>
<p><a href="mypage/mypage1.jsp?strName=성춘향&num1=40&num2=50">성춘향의 정보</a>
</body>
</html>